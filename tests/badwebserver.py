...
<!DOCTYPE html>
	<head>
		...
		<link rel="stylesheet" href="stylesheet.css" id="css01">
		<script src="/script.js" type="text/javascript" id="script01"></script>
	...
	<body>
		...
		<img src='/cool_pic.jpg' width='100px' height='100px' id='img01'>
		<article>
			<input type="text" id="for_script01"> External Script (#script01) URL<br>
			<input type="text" id="for_img01"> External Image (#img01) URL<br>
			<input type="text" id="for_css01"> External Stylesheet (#css01) URL<br>
		</article>
	</body>
</html>"""
...
alert("Javascript resource ('#script_01') loaded successfully after %s attempt");""" % args.tries
